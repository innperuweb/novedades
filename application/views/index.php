...
<?php if (!empty($sliders)): ?>
    <?php foreach ($sliders as $i => $s): ?>
        ...
        <li data-index="rs-<?= $s['id'] ?>"
            ...
            <div class="tp-caption     rev_group" id="slide-15-layer-1"
                 data-x="['left','left','center','center']"
                 data-hoffset="['120','120','0','0']"
                 data-y="['middle','middle','top','top']"
                 data-voffset="['0','0','0','0']"
                 data-width="['838','838','350','300']"
                 data-height="['808','808','350','300']"
                 data-whitespace="nowrap"
                 data-type="group"
                 data-responsive_offset="on"
                 data-frames='[{"delay":10,"speed":300,"frame":"0","from":"opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                 style="z-index: 5; min-width: 838px;">

                <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme" id="slide-15-layer-2"
                     data-x="['center','center','center','center']"
                     data-y="['middle','middle','middle','middle']"
                     data-width="['680','680','300','280']"
            ...
            <div class="tp-caption     rev_group" id="slide-15-layer-4"
                 data-x="['right','right','center','center']"
                 data-hoffset="['120','120','0','0']"
                 data-y="['middle','middle','bottom','bottom']"
                 data-voffset="['0','0','40','30']"
                 data-width="['609','609','541','352']"
                 data-height="['232','232','185','163']"
                 data-type="group"
                 data-responsive_offset="on"
                ...
                <div class="tp-caption tp-resizeme" id="slide-15-layer-5"
                     data-x="center" data-y="top"
                     data-fontsize="['24','24','20','20']"
                     style="z-index: 9; font-size: 24px; font-family:Montserrat;color:#282828;">
                     <?= htmlspecialchars($s['subtitulo']) ?>
                </div>
                <?php endif; ?>

                <div class="tp-caption tp-resizeme" id="slide-15-layer-6"
                     data-x="center" data-y="top"
                     data-fontsize="['78','78','60','40']"
                     style="z-index: 10; font-size: 78px; font-family:Montserrat;color:#282828;">
                     <?= htmlspecialchars($s['titulo'] ?: 'Slide') ?>
                </div>

                <?php if (!empty($s['boton_url'])): ?>
                <a class="tp-caption LaBtnOutlineBlack rev-btn"
                   href="<?= htmlspecialchars($s['boton_url']) ?>"
                   target="_blank" rel="noopener noreferrer"
                   id="slide-15-layer-7"
                   data-x="center" data-y="top"
                   style="z-index: 11;border-color:rgb(40,40,40);">
                   <?= htmlspecialchars($s['boton_url']) ?>
                </a>
                <?php endif; ?>
