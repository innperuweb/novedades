            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <?php endif; ?>
                        <input type="file" name="imagen[<?= $posicion; ?>]" id="imagen-<?= $posicion; ?>" accept=".jpg,.jpeg,.png,.webp" class="form-control <?= isset($errores[$posicion]['imagen']) ? 'is-invalid' : ''; ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="titulo[<?= $posicion; ?>]" id="titulo-<?= $posicion; ?>" class="form-control <?= isset($errores[$posicion]['titulo']) ? 'is-invalid' : ''; ?>" value="<?= e($registro['titulo'] ?? ''); ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="subtitulo[<?= $posicion; ?>]" id="subtitulo-<?= $posicion; ?>" class="form-control <?= isset($errores[$posicion]['subtitulo']) ? 'is-invalid' : ''; ?>" value="<?= e($registro['subtitulo'] ?? ''); ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="texto[<?= $posicion; ?>]" id="texto-<?= $posicion; ?>" class="form-control <?= isset($errores[$posicion]['texto']) ? 'is-invalid' : ''; ?>" value="<?= e($registro['texto'] ?? ''); ?>" required>
