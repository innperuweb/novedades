                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 text-md-start text-center mb-sm--20">
                                    <div class="shop-toolbar__left">
                                        <p class="product-pages">Cantidad 1–20 de 42 resultados</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="shop-toolbar__right">
                                        <div class="product-ordering">
                                            ...
                                            <ul class="product-ordering__list">
                                                <li class="active"><a href="#">Precio menor a mayor</a></li>
                                                <li><a href="#">Precio mayor a menor</a></li>
                                                <li><a href="#">Ordenar A - Z</a></li>
                                                <li><a href="#">Ordenar Z - A</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
